...
public class Trenes extends Discounts {
    public void ExtractTrenes(String text)  {

        Sheet OfertaSheet;
        if (FileCreationForExcel.getSheet("Trenes") == null) {
            OfertaSheet = FileCreationForPDF.createSheet("Trenes");
        } else {
            OfertaSheet = FileCreationForPDF.getSheet("Trenes");
        }
